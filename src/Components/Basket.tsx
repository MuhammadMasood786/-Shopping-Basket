      ...
      <div className="cart-empty">
        {
          baskets.filter((prod) => prod.added).length === 0 ? (<>
            ...
            <Link to="product"> <button type="button" className="btn btn-outline-dark" onClick={() => navigate('/')}  >Shop Now</button></Link>
          </>) : ' '
        }
      </div>
                    ...
                    <div className="box">
                      ...
                      <div className="col-md-6">
                        ...
                        <div className="row justify-content-center mt-5">
                          <button type="button" className="btn btn-outline-danger" onClick={() => dispatch(clear(prods))}>All Remove</button>
                        </div>
                      </div>
                    </div>
                  </div>
